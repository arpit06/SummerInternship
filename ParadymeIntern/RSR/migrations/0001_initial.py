# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-08-11 19:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PhoneNumber', models.CharField(default=0, max_length=50, verbose_name='Phone')),
                ...
                ('TypeResume', models.CharField(choices=[('Employee', 'Employee'), ('Intern', 'Intern'), ('Prospective Employee', 'Prospective Employee'), ('Prospective Intern', 'Prospective Intern')], default='Current Employee', max_length=50, verbose_name='Resume Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('StartDate', models.DateField(default=11, verbose_name='Start Date')),
                ('EndDate', models.DateField(default=11, verbose_name='End Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ProfessionalExperience', models.ManyToManyField(through='RSR.PersonToProfessionalDevelopment', to='RSR.Person')),
            ],
        ),
        migrations.CreateModel(
            name='School',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Volunteer', models.ManyToManyField(through='RSR.PersonToVolunteering', to='RSR.Person')),
            ],
        ),
        migrations.AddField(
